...
NUM_EPOCHS = 15
ANS={"Test 1":[],"Test 2":[],"Test 3":[],"train_loss":[],"val_loss":[]}
for epoch in range(1, NUM_EPOCHS+1):
    ...
    TMP=translate(transformer, "我 来自 北京 。") #要求：更换不同的、一个列表的语句测试效果
    ANS['Test 1'].append(TMP)
    print(TMP)
    TMP=translate(transformer, "我 是 中华人民共和国 公民 。") #要求：更换不同的、一个列表的语句测试效果
    ANS['Test 2'].append(TMP)
    print(TMP)
    TMP=translate(transformer, "我 喜欢 吃 西红柿 炒 鸡蛋 。") #要求：更换不同的、一个列表的语句测试效果
    ANS['Test 3'].append(TMP)
    print(TMP)
    ANS['train_loss'].append(train_loss)
    ANS['val_loss'].append(val_loss)
    filename='1.txt'
