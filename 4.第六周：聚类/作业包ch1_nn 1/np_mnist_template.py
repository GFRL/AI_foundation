...
class Network(object):
    ...
    def step(self, x_batch, y_batch):
        ...
        for i in range(x_batch.shape[0]):#x_vatch[i],y_batch[i]
            ...
            s=x_batch_array[i].reshape(1,x_batch.shape[1]);
...
if __name__ == '__main__':
    # 训练网络
    net = Network(input_size=784, hidden_size=256, output_size=10, lr=0.15)
    best_W1=net.W1
    best_W2=net.W2
    best_b1=net.b1
    best_b2=net.b2
